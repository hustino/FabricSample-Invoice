...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	invoices := []Invoice{
		Invoice{ BilledTo: "Lenovo", InvoiceDate: "2/7/2019", InvoiceAmount: "2000", ItemDescription: "some here", GoodsReceived: "yes", IsPaid: "no", PaidAmount: "1000", Repaid: "no", RepaymentAmount: "200"},
	}
